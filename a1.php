...
<body class="d-flex flex-column min-vh-100">
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
          <div class="navbar-nav border-mobile">
            ...
            <a class="nav-link disabled mx-2" href="a1.php">Ailan</a>
    ...
    <p id="ailandesc"> Click Each Letter In Ailan's Name For A Surprise</p>

    <div id="ailanblock" class="container-fluid">
      <a target="_blank" href="images/7.jpeg"><h2 id="ailanletra">A</h2></a>
      <a target="_blank" href="images/8.jpeg"><h2 id="ailanletra">I</h2></a>
      <a target="_blank" href="images/9.jpeg"><h2 id="ailanletra">L</h2></a>
      <a target="_blank" href="images/10.jpeg"><h2 id="ailanletra">A</h2></a>
      <a target="_blank" href="images/11.jpeg"><h2 id="ailanletra">N</h2></a>
    </div>
