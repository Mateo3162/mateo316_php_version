      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
          <div class="navbar-nav border-mobile">
            ...
            <a class="nav-link disabled mx-2" href="thanks.php">Thanks</a>   
          </div>
          <button type="button" class="btn btn-danger m-2" onclick="logout()">Logout</button>
        </div>
      </div>
  </nav>
    <div class="ma-auto" id="thanks">
        <p>Special thanks to everyone that visits the page.</p>
        <p>I really appreciate you and I hope you enjoy it.</p>
        <p>&#60;3</p>
        <img src="images/thanks.gif" class="mx-auto img-fluid">
    </div>
